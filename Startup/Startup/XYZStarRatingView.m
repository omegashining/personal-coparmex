...
@implementation XYZStarRatingView
...
- (id)initWithFrame:(CGRect)frame andRating:(int)rating withLabel:(BOOL)label animated:(BOOL)animated
{
    ...
    if (self) {
        ...
        starBackground.contents = (__bridge id)([UIImage imageNamed:@"five_stars_gray"].CGImage);
        ...
        starMask.contents = (__bridge id)([UIImage imageNamed:@"five_stars_gray"].CGImage);
